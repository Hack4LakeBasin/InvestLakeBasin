...
<body>
    ...
    <div class="container" style="margin-top: 80px;">
        ...
        <form><label>Full Name</label><input class="form-control" type="text" placeholder="Full Name"><label>Email</label><input class="form-control" type="text" placeholder="Email"><label>Phone</label><input class="form-control" type="text" placeholder="Phone"><label>Organization Name</label>
            <input
                class="form-control" type="text" placeholder="Organization Name:"><label>National ID Number</label><input class="form-control" type="text" placeholder="National ID Number"><label>KRA pin</label><input class="form-control" type="text" placeholder="KRA Pin"><label>Password:</label><input class="form-control"
                    type="text" placeholder="Password"><label>Retype Password:</label><input class="form-control" type="text" placeholder="Retype password"><button class="btn btn-primary btn-block" type="button" style="margin-top: 20px;">Sign Up</button></form>
    </div>
